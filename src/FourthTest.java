...
//  training version with concat = "//*[@resource-id='org.wikipedia:id/page_list_item_description']//*[@text='Object-oriented programming language']"
 ...
 @Test
     ...
     WaitForElementPresentByXpath("//*[@class='android.widget.TextView']",
             "Cannot find announcement banner element",
             5);

     WaitForElementByXpathAndClick("//*[@class='android.widget.TextView']",
...
// doesn't work
     WaitForElementNotPresentByXpath("//*[@resource-id='org.wikipedia:id/search_lang_button']",
